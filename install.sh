...
EOF
    ...
    curl -o /usr/bin/V2bX -Ls https://raw.githubusercontent.com/pjy02/V2bX-script/master/V2bX.sh
    ...
    if [[ $first_install == true ]]; then
        ...
        if [[ $if_generate == [Yy] ]]; then
            curl -o ./initconfig.sh -Ls https://raw.githubusercontent.com/pjy02/V2bX-script/master/initconfig.sh
